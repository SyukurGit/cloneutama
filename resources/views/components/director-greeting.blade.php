{{-- ========================================================== --}}
{{--       BUNGKUS SELURUH KONTEN DENGAN PENGECEKAN INI        --}}
{{-- ========================================================== --}}
@if(isset($settings['director_greeting_enabled']) && $settings['director_greeting_enabled'] == 'on')
                ...
                <div class="relative max-w-xs mx-auto">
                    ...
                    <div class="bg-gray-300 p-1.5 rounded-lg shadow-lg">
                        ...
                        @if(app()->getLocale() == 'en' && !empty($settings['director_image']))
                            <img src="{{ asset('storage/' . $settings['director_image']) }}" alt="Director's Photo" class="w-full aspect-[4/5] object-cover rounded-md">
                        @else
                            <img src="{{ asset('images/direktur.png') }}" alt="Director's Photo" class="w-full aspect-[4/5] object-cover rounded-md">
                        @endif
                    </div>
