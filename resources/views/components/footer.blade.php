...
<img src="{{ asset('images/logo.png') }}" alt="Postgraduate Logo" class="h-20 sm:h-24 w-auto mb-4 sm:mb-6 md:mb-0 md:mr-8 bg-white p-1 rounded shadow">
            ...
            <div class="text-sm w-full md:w-auto">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-2 sm:gap-x-4">
                    ...
                    <div class="flex items-center mb-1">
                        <span class="w-5 mr-2 flex-shrink-0">📧</span>
                        <a href="mailto:email@ar-raniry.ac.id" class="hover:text-white transition-colors">email@ar-raniry.ac.id</a>
                    </div>
                </div>
            </div>
        </div>
...
{{-- FONT AWESOME SCRIPT FOR SOCIAL MEDIA ICONS --}}
{{-- You can place this in your main layout if it's already included, or leave it here --}}
