        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="label" id="label" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md" value="{{ old('label', $information->label) }}" placeholder="Contoh: Pengumuman, Brosur">
                </div>
